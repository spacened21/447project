...
urlpatterns = [
    ...
    path("api/inventory/<int:item_id>/", inventory_detail_view),
    path("api/inventory/<int:item_id>/edit/", inventory_update_view),
    ...
    path("api/inventory/<int:item_id>/photo/", inventory_photo_upload_view),
